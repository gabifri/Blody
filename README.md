...
## 📥 Installation
1. Télécharger le dossier ([sourcecode.zip](https://github.com/gabifri/Blody/archive/refs/tags/V.1.4.4.zip)) de l'extension dans le [releases](https://github.com/gabifri/Blody/releases/tag/V.1.4.4) (dernière version 1.4.4).
